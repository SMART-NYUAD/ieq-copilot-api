...
class RoutingGoldenSuiteTests(unittest.TestCase):
    GOLDEN_CASES = [
        ...
        {"q": "Which lab had lower PM2.5 today, smart_lab or eco_lab?", "intent": "comparison_db", "conf": 0.92, "mode": "db", "exec": "db_query", "rule": "measured_scope_forces_db", "rationale": "today comparison"},
        ...
        {"q": "Show temperature trend for eco_lab past 7 days", "intent": "aggregation_db", "conf": 0.9, "mode": "db", "exec": "db_query", "rule": "measured_scope_forces_db", "rationale": "past-N-days trend"},
        ...
        {"q": "PM2.5 in smart_lab vs eco_lab over last month", "intent": "comparison_db", "conf": 0.9, "mode": "db", "exec": "db_query", "rule": "measured_scope_forces_db", "rationale": "explicit compare period"},
        ...
        {"q": "What are the latest TVOC readings in eco_lab?", "intent": "current_status_db", "conf": 0.9, "mode": "db", "exec": "db_query", "rule": "measured_scope_forces_db", "rationale": "latest readings"},
        ...
        {"q": "How is it over there?", "intent": "aggregation_db", "conf": 0.25, "mode": "db", "exec": "clarify_gate", "rule": "clarify_gate_confidence_or_strategy", "rationale": "ambiguous reference low confidence"},
        {"q": "Can you check that trend?", "intent": "aggregation_db", "conf": 0.25, "mode": "db", "exec": "clarify_gate", "rule": "clarify_gate_confidence_or_strategy", "rationale": "missing metric/lab/time"},
        {"q": "Is this okay?", "intent": "unknown_fallback", "conf": 0.25, "mode": "knowledge_only", "exec": "clarify_gate", "rule": "clarify_gate_confidence_or_strategy", "rationale": "underspecified follow-up"},
        {"q": "What about the other one?", "intent": "comparison_db", "conf": 0.25, "mode": "db", "exec": "clarify_gate", "rule": "clarify_gate_confidence_or_strategy", "rationale": "comparison without entities"},
        ...
        {"q": "What changed?", "intent": "aggregation_db", "conf": 0.25, "mode": "db", "exec": "clarify_gate", "rule": "clarify_gate_confidence_or_strategy", "rationale": "insufficient disambiguation"},
